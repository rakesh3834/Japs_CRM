...
try {
  ...
  for (const file of ["tests/database-fixtures.sql", "supabase/schema.sql", "supabase/migrations/20260917_verified_staff_whatsapp.sql", "supabase/bootstrap_verified_admin.sql", "tests/database-assertions.sql"]) {
